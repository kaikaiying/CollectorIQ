...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="app-main" style={{ paddingBottom: '2rem' }}>
      ...
      <P>
        Watch Collector — Accuracy Tracker ("we," "our," "us") is committed to protecting your privacy. This Privacy Policy outlines how your personal information is collected, used, and disclosed when you use our app across all jurisdictions including Canada, the United States, the European Union, and any other applicable regions. Watch Collector — Accuracy Tracker is designed to help watch enthusiasts track and analyze the performance of their watches. By signing up and using the app, you agree to all terms of this Privacy Policy, including the collection, use, and processing of your data as described herein. This document also serves as our Terms of Service, governing your use of Watch Collector — Accuracy Tracker.
      </P>

      <Section title="Consent Upon Sign-Up">
        <P>By creating an account or using Watch Collector — Accuracy Tracker, you explicitly consent to the collection and use of your personal and watch performance data as outlined in this Privacy Policy. If you do not agree with any part of this policy, please do not use the app.</P>
      </Section>
      ...
      <Section title="10. Children">
        <P>Watch Collector — Accuracy Tracker is not intended for users under the age of 13. We do not knowingly collect personal data from children without parental consent.</P>
      </Section>
      ...
      <Section title="User Responsibilities">
        <P>Users agree to use Watch Collector — Accuracy Tracker only for lawful purposes and not misuse the service.</P>
      </Section>
      ...
      <Section title="Intellectual Property">
        <P>Watch Collector — Accuracy Tracker's concept — including but not limited to the housing of watch movement specifications, automated comparison of user-submitted timing data against those specifications, and the generation of service suggestions based on such comparisons — is the original intellectual property of Watch Collector — Accuracy Tracker. All content within the app, including designs, logos, copy, data models, and timing analysis tools, is owned by Watch Collector — Accuracy Tracker and protected by applicable copyright, trademark, and intellectual property laws. Any reproduction, modification, distribution, reverse engineering, or unauthorized use of this intellectual property is strictly prohibited and may result in legal action.</P>
      </Section>
      ...
      <Section title="Cancellations">
        ...
        <List items={[
          'iOS: Settings → [Your Name] → Subscriptions → Watch Collector → Cancel.',
      ...
      <P style={{ marginTop: '1.5rem' }}>By using Watch Collector — Accuracy Tracker, you consent to this Privacy Policy.</P>
    </div>
  )
}
